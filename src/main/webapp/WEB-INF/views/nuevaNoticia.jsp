    ...
    <c:when test="${sessionScope.usuarioLogin.rol == 'ADMIN'}" >
		...
		<div class="container" style="margin-top:20px;" align="center">
			...
			<thead class="thead-dark">
				    <tr>
				      <th scope="col"style="font-size: 25px"> NUEVA NOTICIA</th>
				    </tr>
		  	</thead>
		  		<form:form id="regForm" class="form-signin" modelAttribute="noticia" action="${contextPath}/nuevaNoticia/crear" method="post">
		  		<tr align="center" class="bg-dark text-white">
				    <td style="font-size: 20px"> TÍTULO </td>
				 </tr>
				<tr align="center"  class="bg-light text-dark">
					<td style="font-size: 22px"> <form:input path="titulo" name="titulo" id="titulo" class="form-control" style="width: 900px;"/> </td>
				</tr> 
				<tr align="center" class="bg-dark text-white">
					<td style="font-size: 20px"> CONTENIDO </td>
				</tr> 
				<tr align="center"  class="bg-light text-dark">
					<td style="font-size: 22px"> <form:textarea path="contenido" name="contenido" id="contenido" class="form-control" style="width: 900px; height: 300px;" /> </td>
				</tr> 
		  		<tr class="bg-light text-dark" align="center">
		  			<td><form:button class="btn btn-primary text-uppercase" id="publicar" type="submit" style="width: 500px;" >Publicar noticia </form:button></td>	
		  		</tr>
		  		</form:form>
			</table>
